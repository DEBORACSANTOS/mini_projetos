from agenda_p.fonte.agenda import Agenda
from agenda_p.fonte.contato import Contato
from agenda_p.fonte.fone import Fone
from agenda_p.fonte.identificador import Identificador
...
if __name__ == '__main__':
    ...
    print("Total de telefones cadastrados na agenda_p é igual a " + quantidadeTotal)
    # "Total de telefones cadastrados na agenda_p é igual a 6

    if not agenda.removerContato("Alex"):
        print("fail: nome do contato não esta cadastrado na agenda_p")
        # fail: nome do contato não esta cadastrado na agenda_p
