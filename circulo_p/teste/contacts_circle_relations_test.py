...
from ..fonte.aluno.base.circulo import Circulo
from ..fonte.aluno.base.contato import Contato
from ..fonte.aluno.g_contatos import GContatos
from ..fonte.aluno.cliente.circulo_not_found_exception import CirculoNotFoundException
from ..fonte.aluno.cliente.contato_not_found_exception import ContatoNotFoundException
...
class ContactsCircleRelationsTest(unittest.TestCase):
    ...
    def test_adicionarContatoCirculoExistente(self):
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo_p deve ser adicionado")
        self.assertTrue(self.gcont.createContact(self.JAMES, self.JAMES_EMAIL), "O contato deve ser adicionado")
        self.assertTrue(self.gcont.tie(self.JAMES, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")
        self.assertEqual(1, self.gcont.getCircle(self.FAMILIA).getNumberOfContacts(),
                         "Numero de contatos no circulo_p errado")
        self.assertEqual([self.familia], self.gcont.getCircles(self.JAMES), "Lista de circulos do contato esta errada")
        self.assertEqual([self.james], self.gcont.getContacts("familia"), "Lista de contatos de um circulo_p esta errada")
    ...
    def test_adicionarContatoCirculoInexistente(self):
        ...
        self.assertTrue(cm.getCirculoNaoEncontrado() == self.FAMILIA, "A excecao nao retornou o id do circulo_p que nao existe")

        self.assertEqual(self.gcont.getCircle(self.FAMILIA), None, "Circulo nao existente")
        self.assertEqual([], self.gcont.getCircles(self.JAMES), "Contato nao esta em nenhum circulo_p")

    def test_adicionarContatoDuplicadoCirculoExistente(self):
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo_p deve ser adicionado")
        self.assertTrue(self.gcont.createContact(self.JAMES, self.JAMES_EMAIL), "O contato deve ser adicionado")
        self.assertTrue(self.gcont.tie(self.JAMES, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")
        self.assertFalse(self.gcont.tie(self.JAMES, self.FAMILIA), "Contato ja esta no circulo_p")
        self.assertEqual(1, self.gcont.getCircle(self.FAMILIA).getNumberOfContacts(),
                         "Numero de contatos no circulo_p errado")
        self.assertEqual([self.familia], self.gcont.getCircles(self.JAMES), "Lista de circulos do contato esta errada")
        self.assertEqual([self.james], self.gcont.getContacts("familia"), "Lista de contatos de um circulo_p esta errada")
    ...
    def test_adicionarAlemDoLimite(self):
        ...
        self.assertTrue(self.gcont.tie(self.JAMES, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.tie(self.JOSE, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.tie(self.ANA, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")
        self.assertFalse(self.gcont.tie(self.JOAQUIM, self.FAMILIA), "Limite do circulo_p atingido")

    def test_adicionarContatoVariosCirculos(self):
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo_p deve ser adicionado")
        self.assertTrue(self.gcont.createCircle(self.AMIGOS, 2), "O circulo_p deve ser adicionado")
        ...
        self.assertTrue(self.gcont.tie(self.JAMES, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.tie(self.MARIO, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.tie(self.JOSE, self.FAMILIA), "Contato deve ser adicionado ao circulo_p")

        self.assertTrue(self.gcont.tie(self.JAMES, self.AMIGOS), "Contato deve ser adicionado ao circulo_p")
        ...
        self.assertEqual([self.james, self.jose, self.mario], self.gcont.getContacts(self.FAMILIA),
                         "Lista de contatos de um circulo_p esta errada")
    ...
    def test_removendoContatoDoCirculo(self):
        ...
        self.assertTrue(self.gcont.untie(self.JAMES, self.AMIGOS), "Contato deve ser removido ao circulo_p")
    ...
    def test_removendoContatoDoCirculoInexistente(self):
        ...
        self.assertTrue(cm.getCirculoNaoEncontrado() == self.FAMILIA,
                        "A excecao nao retornou o id do circulo_p que nao existe")

    def test_removendoCirculoQuePossuiContatos(self):  # throws CirculoNotFoundException, ContatoNotFoundException {
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo_p deve ser adicionado")
        self.assertTrue(self.gcont.createCircle(self.AMIGOS, 2), "O circulo_p deve ser adicionado")
        self.assertTrue(self.gcont.createCircle(self.TRABALHO, 3), "O circulo_p deve ser adicionado")
        ...
        self.assertTrue(self.gcont.tie(self.JAMES, self.TRABALHO), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.tie(self.JOAQUIM, self.TRABALHO), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.tie(self.ANA, self.TRABALHO), "Contato deve ser adicionado ao circulo_p")

        self.assertTrue(self.gcont.tie(self.JAMES, self.AMIGOS), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.removeCircle(self.FAMILIA), "O circulo_p deve ser removido")
    ...
    def test_removendoContatosQueEstaEmCirculos(self):  # $ throws CirculoNotFoundException, ContatoNotFoundException {
        ...
        self.assertEqual([self.jose, self.mario], self.gcont.getContacts("familia"),
                         "A lista de contatos do circulo_p esta errada")

        self.assertEqual([self.ana, self.joaquim], self.gcont.getContacts("trabalho"),
                         "A lista de contatos do circulo_p esta errada")

        self.assertEqual([], self.gcont.getContacts("amigos"), "A lista de contatos do circulo_p esta errada")
    ...
    def test_circulosEmComum(self):  # throws CirculoNotFoundException, ContatoNotFoundException {
        ...
        self.assertTrue(self.gcont.tie(self.JAMES, self.AMIGOS), "Contato deve ser adicionado ao circulo_p")
        self.assertTrue(self.gcont.tie(self.MARIO, self.AMIGOS), "Contato deve ser adicionado ao circulo_p")
