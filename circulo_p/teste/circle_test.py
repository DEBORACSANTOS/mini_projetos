...
class CircleTests(unittest.TestCase):
    ...
    def test_adicionarCirculos(self):
        ...
        self.assertTrue(self.gcont.createCircle(self.AMIGOS, 1), "O circulo_p deve ser adicionado")
    ...
    def test_buscandoCirculoExistente(self):
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo_p deve ser adicionado")
        self.assertEqual(self.gcont.getCircle(self.FAMILIA), self.familia, "O circulo_p recuperado nao foi procurado")
    ...
    def test_atualizandoCirculoExistente(self):
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo_p deve ser adicionado")
        self.assertTrue(self.gcont.updateCircle(Circulo(self.FAMILIA, 4)), "O circulo_p deve ser atualizado")
        self.assertEqual(self.gcont.getCircle(self.FAMILIA), Circulo(self.FAMILIA, 4),
                         "O circulo_p nao foi atualizado corretamente")

    def test_atualizandoCirculoLimiteInvalido(self):
        self.assertTrue(self.gcont.createCircle(self.FAMILIA, 3), "O circulo_p deve ser adicionado")
        self.assertFalse(self.gcont.updateCircle(Circulo(self.FAMILIA, 0)), "O circulo_p possui limite invalido")
